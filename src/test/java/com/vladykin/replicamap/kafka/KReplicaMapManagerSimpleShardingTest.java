...
class KReplicaMapManagerSimpleShardingTest {
    ...
    void testSimpleSharding() throws Exception {
        ...
        try (KReplicaMapManager all = new KReplicaMapManager(getShardedConfig(null, false))) {
    ...
    public static void awaitFor(long exp, ToLongFunction<KReplicaMapManager> metric, KReplicaMapManager... ms)
